                ...
                <Box p={[4, 8, 10]} maxWidth="1200px" mx="auto">
                    ...
                    <Flex flexDirection={"column"} align="stretch" fontSize={["16px", "18px"]}>
                        ...
                        <Text mb={4}>
                            ...
                            perfumery, home care, and beverages, we provide the perfect ethanol solution for your
                            specific
                            needs.
                        </Text>
                        <Image mt={4}
                    ...
                    <Flex mt={[16, 16, 32]} fontSize={["16px", "18px"]} justify="space-between"
                        ...
                        <Flex w={['100%', '70%', '45%']} flexDir='column' align="flex-start" gap={2}>
                            ...
                            <UnorderedList spacing={2}>
                                ...
                                <ListItem>
                                    <strong>Grape Ethanol: </strong> Specifically used in the food and beverage
                                    industries.
                                </ListItem>
                            </UnorderedList>
                        </Flex>
                        {/* Our Process */}
                        <Flex width={['100%', '50%']} flexDir='column' align="flex-start" gap={[0, 0, 2]}
