        ...
        <CustomBox>
            <Box>
                <Box p={[4, 8, 10]} maxWidth={["1200px", 'auto']} mx="auto">
                    ...
                    <Flex mt={[16, 16, 32]} fontSize={["16px", "18px"]} justify="space-between"
                        ...
                        <Flex flexDir='column' align="flex-start" gap={[0, 0, 2]} fontSize={["16px", "18px"]}>
                            ...
                            <Text>
                                <strong>1. Consultation:</strong> We start by understanding your needs, target market,
                                and
                                brand
                                vision.
                            </Text>
                            <Text>
                                <strong>2. Development:</strong> Based on your input, we develop a product that aligns
                                with
                                your
                                brand vision.
                            </Text>
                            ...
                            <Text>
                                <strong>4. Delivery:</strong> We deliver the finished product, ready for you to
                                introduce to
                                your market.
                            </Text>
                        </Flex>
                    ...
                    >
                        ...
                        >
                            <Link href={'/services/gift'} _hover={{textDecoration: 'none'}}>
                                ...
                                <Text mb={2} fontSize={["16px", "md", "18px"]} color={"#333333"}>
                                    Be it company gifts, wedding giveaways, or any special occasion, we design gifts
                                    that
                                    leave
