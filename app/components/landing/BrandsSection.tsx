...
export const BrandsSection = ({isLanding, brands, imageUrls}: any) => {
    ...
    return (
        <Box position="relative" pb={8} bg={'white'} color={'#000000'}>
            <Flex pl={8} pt={10} gap={[4, 8]} alignContent={'center'} alignItems={'center'}>
            ...
            {showArrows && (
                <Flex justifyContent={'end'} mt={12} gap={12} pr={8} pt={8} zIndex={9999}>
                    {canScrollLeft && (
            ...
            {isLanding && (
                <Link _hover={{textDecoration: "none"}} href={`/brands`} >
                    <Box width={["100%", "100%", "18%"]} mt={[8, 0, 6]} pl={8} >
