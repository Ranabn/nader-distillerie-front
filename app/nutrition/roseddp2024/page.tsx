...
export default function RoseWineNutrition() {
    return (
                ...
                <VStack spacing={4} align="stretch">
                    ...
                    <Box textAlign="center">
                        ...
                        <Text fontSize="md" fontFamily="Varta">
                            DRY ROS&Eacute; WINE / VIN ROS&Eacute; SEC
                        </Text>
                    ...
                    <Box>
                        ...
                        <Text fontSize="sm" fontFamily="Varta" mb={3}>
                            Grapes, stabilizing agent (cellulose gum), preservative
                            (sulphites). Bottled under protective atmosphere.
                        </Text>
                        ...
                        <Text fontSize="sm" fontFamily="Varta">
                            Raisins, agent stabilisateur (gomme de cellulose), conservateur
