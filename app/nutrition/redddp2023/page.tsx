...
export default function RedWineNutrition() {
    return (
                ...
                <VStack spacing={4} align="stretch">
                    ...
                    <Box>
                        ...
                        <Text fontSize="sm" fontFamily="Varta" mb={3}>
                            Grapes, stabilizing agent (arabic gum), preservative
                        ...
                        <Text fontSize="sm" fontFamily="Varta">
                            Raisins, agent stabilisateur (gomme arabique), conservateur
