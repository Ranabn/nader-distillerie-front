        ...
        <>
            ...
            <Box mt={32} p={5}>
                ...
                <Box>
                    ...
                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>2. Authorized Use</Heading>
                    <Text  fontSize="sm">
                    ...
                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>3. Intellectual Property Rights</Heading>
                    <Text  fontSize="sm">
                    ...
                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>4. Unaffiliated products and sites</Heading>
                    <Text  fontSize="sm">
                        Our website may contain links and references to other websites administered by unaffiliated third parties.
                    </Text>

                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>5. Sweepstakes & Promotions</Heading>
                    <Text  fontSize="sm">
                    ...
                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>6. Privacy Policy</Heading>
                    <Text  fontSize="sm">
                        For information about the collection and processing of your Personal Data, please refer to our Privacy Policy.
                    </Text>

                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>7. Email Transmission</Heading>
                    <Text  fontSize="sm">
                    ...
                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>8. No Warranties; Limitation of Liability</Heading>
                    <Text  fontSize="sm">
                        THIS SITE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESSED OR IMPLIED.
                    </Text>

                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>9. Indemnification</Heading>
                    <Text  fontSize="sm">
                    ...
                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>13. Governing Law and Forum</Heading>
                    <Text  fontSize="sm">
                        These terms of use shall be governed by and construed exclusively in accordance with the laws of Lebanon.
                    </Text>

                    <Heading  size="md" as="h4" size="lg" mt={4} mb={2}>14. Changes to Terms of Use</Heading>
                    <Text  fontSize="sm">
